...
| `.gitignore` | Ignores build/, .gradle/, .idea/, .omc/, local.properties, 反编译参考物(jadx_out/, apktool_out/, *.apk), media/, tools/(本地工具,仅 AGENTS.md 锚点入库) |
...
| `tools/` | 本地参考验证工具(Python;gitignored 不入库,仅 AGENTS.md 锚点被强制跟踪;see `tools/AGENTS.md`) |

...
| `05-cloud-api.md` | Cloud APIs (mtop/ACCS, out of scope) + **§3 LAN IDC 业务模块:RPM 应用管理权威规格(模块名 `com.yunos.idc.appstore`/开启流程/帧格式/鉴权证据) + Cmd 通道直发包帧格式(LaunchSth 20400/SysProp 211xx/PackageInfo 205xx/PathInfo 207xx/VConnFin 20300/11100/11200)** |

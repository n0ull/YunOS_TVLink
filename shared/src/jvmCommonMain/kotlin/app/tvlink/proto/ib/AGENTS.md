...
IB (InputBoost) fast input channel — low-latency TCP 3988 connection for remote-control
key events and motion sensor data. Preferred over IDC for input due to lower overhead.
Falls back to IDC OpCmd_Key when unavailable.
